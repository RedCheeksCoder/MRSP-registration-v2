...
const Template = ({ name, chapter, school, role, competitionCategory, joinAs, qrCode, onLoad }) => {
  ...
  return (
    <>
      <Container>
        <Logo>
          <img src="/logo1.png" alt="" onLoad={handleImageLoad} />
          <img src="/logo2.png" alt="" onLoad={handleImageLoad} />
          <img src="/logo3.png" alt="" onLoad={handleImageLoad} />
          <img src="/logo4.png" alt="" onLoad={handleImageLoad} />
          <img src="/logo5.png" alt="" onLoad={handleImageLoad} />
          <img src="/logo6.png" alt="" onLoad={handleImageLoad} />
          <img src="/logo7.png" alt="" onLoad={handleImageLoad} />
          <DotsTop src="/topdots.jpg" alt="" height={200} width={200} onLoad={handleImageLoad} />
        </Logo>
        <TemplateContainer id="template">
          <Info>
            <DotsLeft src="/leftdots.jpg" alt="" height={200} width={100} onLoad={handleImageLoad} />
            <Name>{name}</Name>
            <Details>{school}</Details>
            <Details>{chapter}</Details>
            <Details>{role}</Details>
